...
from volatility.plugins.overlays.windows.windows import AbstractWindows
import volatility.plugins.overlays.windows.xp_sp2_x86_vtypes as xp_sp2_x86_vtypes
...
class WinXPSP2(AbstractWindows):
