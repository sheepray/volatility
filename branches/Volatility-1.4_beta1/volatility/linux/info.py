...
def info_systime(addr_space, theProfile, symtab):
    ...
    timespec = obj.Object('timespec', xtime_vaddr, addr_space, \
                        None, theProfile)
    return timespec

def info_timezone(addr_space, theProfile, symtab):
    sys_tz_vaddr = symtab.lookup('sys_tz')
    sys_tz = obj.Object('timezone', sys_tz_vaddr, addr_space, \
                        None, theProfile)
    return sys_tz
...
def info_system_utsname(addr_space, theProfile, symtab):
    ...
    if system_utsname_vaddr != None:
        system_utsname = obj.Object('new_utsname', system_utsname_vaddr, addr_space, None, theProfile)

    elif symtab.lookup('init_uts_ns') != None:
        init_uts_ns_vaddr = symtab.lookup('init_uts_ns')
        system_utsname = obj.Object('new_utsname', init_uts_ns_vaddr, addr_space, None, theProfile)
    else:
        system_utsname = None
