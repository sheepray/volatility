...
def ps_scan(addr_space, types, _filename, beg, end, slow):
...
def check_thread_start_address(address, object):
    UniqueProcess =  read_obj(object.addr_space, object.types, ['_ETHREAD', 'Cid', 'UniqueProcess'], address)
    StartAddress = read_obj(object.addr_space, object.types, ['_ETHREAD', 'StartAddress'], address)
...
def socket_scan(addr_space, types, _filename, beg, end, slow):
...
def conn_scan(addr_space, types, _filename, beg, end, slow):
